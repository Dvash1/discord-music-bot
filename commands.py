...
# Formats time of song from 00:00:00 and so on to a more readable format. For example, a 30 second song would be shown as '00:30' instead of '00:00:30'
...
def deformat_duration(time_str):
    #Converts to miliseconds from 00:00:00 format.
